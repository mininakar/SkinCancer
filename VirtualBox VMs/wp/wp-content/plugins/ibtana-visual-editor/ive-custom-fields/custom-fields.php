      ...
      if( $custom_repeater_item ){
        foreach( $custom_repeater_item as $item_key => $item_value ){
          ...
          <tr class="wc-sub-row">
            <td>
              <p>Title:</p>
              <input name="custom_repeater_item[<?php echo $item_key; ?>][f_title]" type="text" value="<?php echo (isset($item_value['f_title'])) ? $item_value['f_title'] : ''; ?>" style="width:98%;" placeholder="Title" required>
            </td>
            <td>
              <p>Name:</p>
              <input name="custom_repeater_item[<?php echo $item_key; ?>][f_name]" type="text" value="<?php echo (isset($item_value['f_name'])) ? $item_value['f_name'] : ''; ?>" style="width:98%;" placeholder="Name" required>
            </td>
            <td>
              <p>Type:</p>
              <?php
              ...
              <select name="custom_repeater_item[<?php echo $item_key; ?>][f_type]" style="width:98%;">
                <option value="text" <?php echo ($selected_value === 'text') ? 'selected' : ''; ?>>Text</option>
                <option value="select" <?php echo ($selected_value === 'select') ? 'selected' : ''; ?>>Select</option>
                <option value="repeater" <?php echo ($selected_value === 'repeater') ? 'selected' : ''; ?>>Repeater</option>
