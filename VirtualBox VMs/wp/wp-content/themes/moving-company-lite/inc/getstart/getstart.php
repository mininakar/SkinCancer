...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks" onclick="moving_company_lite_open_tab(event, 'product_addons_editor')"><?php esc_html_e( 'Woocommerce Product Addons', 'moving-company-lite' ); ?></button>
		...
		<div id="block_pattern" class="tabcontent">
			...
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($moving_company_lite_plugin_custom_css); ?>">
				<div class="block-pattern-img">
              	...
              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon.','moving-company-lite'); ?></span></b></p>
              	<div class="moving-company-lite-pattern-page">
					...
					<img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/block-pattern1.png" alt="" />
				    	<p><b><?php esc_html_e('Click on Patterns Tab >> Click on Theme Name >> Click on Sections >> Publish.','moving-company-lite'); ?></span></b></p>
		...
		<div id="product_addons_editor" class="tabcontent">
			<?php if(!class_exists('IEPA_Loader')){
				$plugin_ins = Moving_Company_Lite_Plugin_Activation_Woo_Products::get_instance();
				$moving_company_lite_actions = $plugin_ins->recommended_actions;
				?>
				<div class="moving-company-lite-recommended-plugins">
					    <div class="moving-company-lite-action-list">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Woocommerce Products Blocks', 'moving-company-lite' ); ?></h3>
				<hr class="h3hr">
				<div class="moving-company-lite-pattern-page">
					<p><?php esc_html_e('Follow the below instructions to setup Products Templates.','moving-company-lite'); ?></p>
					<p><b><?php esc_html_e('1. First you need to activate these plugins','moving-company-lite'); ?></b></p>
						<p><?php esc_html_e('1. Ibtana - WordPress Website Builder ','moving-company-lite'); ?></p>
						<p><?php esc_html_e('2. Ibtana - Ecommerce Product Addons.','moving-company-lite'); ?></p>
						<p><?php esc_html_e('3. Woocommerce','moving-company-lite'); ?></p>

					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','moving-company-lite'); ?></span></b></p>
	              	<div class="moving-company-lite-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-woocommerce-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','moving-company-lite'); ?></a>
			    	</div>
	              	<p><?php esc_html_e('You can create a template as you like.','moving-company-lite'); ?></span></p>
			    </div>
			<?php } ?>
		</div>
