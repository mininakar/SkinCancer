 ...
 */
?>
<div class="top-bar <?php if( get_theme_mod( 'moving_company_lite_sticky_header', false) == 1 || get_theme_mod( 'moving_company_lite_stickyheader_hide_show', false) == 1) { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-4 align-self-center">
		        <div class="logo">
		            ...
		            <?php $blog_info = get_bloginfo( 'name' ); ?>
		                ...
		                <?php if ( is_front_page() && is_home() ) : ?>
		                	<?php if( get_theme_mod('moving_company_lite_logo_title_hide_show',true) == 1){ ?>
		                ...
		                <?php endif; ?>
		              	...
		              	?>
		              	<?php if( get_theme_mod('moving_company_lite_tagline_hide_show',false) == 1){ ?>
	      	...
	      	<?php if( get_theme_mod( 'moving_company_lite_header_search',true) == 1) { ?>
